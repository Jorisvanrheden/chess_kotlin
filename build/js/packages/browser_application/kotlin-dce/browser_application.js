(function (root, factory) {
  ...
  Coord.$metadata$ = {kind: Kind_CLASS, simpleName: 'Coord', interfaces: []};
  ...
  Wrapper.$metadata$ = {kind: Kind_CLASS, simpleName: 'Wrapper', interfaces: []};
  ...
  Coordinate.$metadata$ = {kind: Kind_CLASS, simpleName: 'Coordinate', interfaces: []};
  ...
  Direction.$metadata$ = {kind: Kind_CLASS, simpleName: 'Direction', interfaces: []};
  ...
  PlayerType.$metadata$ = {kind: Kind_CLASS, simpleName: 'PlayerType', interfaces: [Enum]};
  ...
  Bishop.$metadata$ = {kind: Kind_CLASS, simpleName: 'Bishop', interfaces: [Piece]};
  ...
  King.$metadata$ = {kind: Kind_CLASS, simpleName: 'King', interfaces: [Piece]};
  ...
  Knight.$metadata$ = {kind: Kind_CLASS, simpleName: 'Knight', interfaces: [Piece]};
  function Piece(playerType) {
    this.playerType = playerType;
  }
  Piece.$metadata$ = {kind: Kind_CLASS, simpleName: 'Piece', interfaces: []};
  ...
  Queen.$metadata$ = {kind: Kind_CLASS, simpleName: 'Queen', interfaces: [Piece]};
  ...
  Rook.$metadata$ = {kind: Kind_CLASS, simpleName: 'Rook', interfaces: [Piece]};
  ...
  Object.defineProperty(PlayerType, 'WHITE', {get: PlayerType$WHITE_getInstance});
  Object.defineProperty(PlayerType, 'BLACK', {get: PlayerType$BLACK_getInstance});
